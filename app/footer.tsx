    ...
    <footer className="bg-background/95 border-t">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-10 md:grid-cols-[1.8fr_1fr_1fr]">
        <div className="flex flex-col gap-5">
          ...
          <p className="max-w-md text-sm leading-7 ">Payoy adalah platform modern yang membantu pengguna mengelola kebutuhan digital dengan lebih mudah, cepat, dan nyaman.</p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <h3 className="text-lg font-extrabold">Sosial Media</h3>
          <nav className="grid gap-2 text-sm">
            {socialItems.map((item) => (
              <Link key={item.label} href={item.href} className="flex items-center gap-2  transition hover:text-primary">
      ...
      <div className="mx-auto max-w-6xl border-t p-4 text-center text-sm ">
